            ...
            # or however your naming convention is set
                data_entry = {
                    ...
                    "videos": [
                        ...
                        "havid_sub_videos_crop/rh_v0/train/" + os.path.splitext(filename)[0] + ".mp4"
                    ]
                }
...
def main():
    ...
    split_videos_folder = "./havid_sub_videos_crop/rh_v0/train"
    ...
    output_json = "./json/CCFT_havid_sub_videos_crop_rh_v0_simple_v2.json"
