...
def read_annotation_file(label, action_verb_mapping, object_mapping, tool_mapping, label_mapping):
    ...
    valid_classes = """A primitive task can be decomposed into 4 action elements: Action verb, Manipulated object, Target object, and Tool. Describe the primitive task in a compositional way, using the four action elements. 
                    Possible classes for each action element and primitive task are the following:
    ...
    assistant_text = "Conclusion: " + description
            ...
            # or however your naming convention is set
                data_entry = {
                    ...
                    "videos": [
                        ...
                        "havid_sub_videos/lh_v0/train/" + os.path.splitext(filename)[0] + ".mp4"
                    ]
                }
...
def main():
    ...
    output_json = "./json/CCFT_havid_sub_videos_crop_lh_v0_cot.json"
