...
def split_videos_by_annotations(annotation_folder, video_folder, output_folder):
    ...
    for video_filename in os.listdir(video_folder):
        ...
        if not os.path.exists(annotation_path):
            print(f"[WARNING] No matching .txt for annotation: {ann_filename}")
            continue
...
def main():
    ...
    annotation_folder = "./groundTruth/View2/rh_pt"
    video_folder = "./trimmed_videos/view2"
    output_folder = "./havid_sub_videos/rh_v2"
